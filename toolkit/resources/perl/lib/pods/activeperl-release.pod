=head1 ActivePerl 1205 -- Release Notes
...
see the <a href="changes.html">ActivePerl 5.12 Change Log</a>.</p>
...
Perl 5.12 is not binary compatible with Perl 5.10 or 5.8.  In particular, do not
attempt to use extensions or PPM packages built for ActivePerl 800 and 1000
series builds with ActivePerl 1200 series builds and vice versa.  Please
check L<perl5120delta/Incompatible Changes> for known source level
incompatibilities between the Perl 5.12 releases and the earlier release
series.
...
ActivePerl 5.12 over an older version of ActivePerl based on 5.10, 5.8, 5.6 or
5.005, such as build 1007 or any other 1000, 800, 600 or 500 series build.  We
...
was installed in F</opt/ActivePerl-5.12> then the HTML documentation
would be located in F</opt/ActivePerl-5.12/html>.
