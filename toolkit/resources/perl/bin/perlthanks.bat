...
my $config_tag1 = '5.12.4 - Mon Jun 20 18:32:45 2011';

my $patchlevel_date = 1308619943;
my $patch_tags = '+ACTIVEPERL_LOCAL_PATCHES_ENTRY +c6fbf28 +1fd8fa4 +f120055 +a2a8d15 +007cfe1 +6d8f7c9 +d956618 +321e50c ';
my @patches = (
